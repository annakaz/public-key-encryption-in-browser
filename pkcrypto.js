q":"tkiO71sEdu9t3708cMvnPh_RJJWqdd2Pu0BhD3I4REXKAKeaRK3j1_yIrII1xSf9Gbjk5q1vGe5eQJ_I0vCiBhZZa_UurjNPmQmLvf79GJmaxuMoLi6LdBPcNk77ZWMmJNSG2GLNktfpNkQ8NCm5CKiGHKQOoknnFWzU9rJvsdk","qi":"rCF6SAWElQz95Ob8i8fLcyKla6UYcLSynf8aItl7BrxW9ZrgUG8fK0_8Io1xfLcSJwBwoohIiTj8BIH_Ln3ZPzlCcdLupZpwNTIsZwSHkcMdQJyA9LK1MqLktRNK6q6qge4BE3ad1DmfPo-ycsOUePu4RUn82WUEnW33BntdwwQ"}';
    const publicKeyJwkString =
      '{"alg":"RSA-OAEP-256","e":"AQAB","ext":true,"key_ops":["encrypt"],"kty":"RSA","n":"iK43c_hhC-TX8GvtT73bfA0LC5MGbDLhu0jmSEtIO37q4jxzP1eNg7E-HkD6XnKpLemoEb_YapTltW4BuExjJ1yO5qeTwxLTkSWxJo_rhRbEmmP9e6tEtLZbrxuPRuZ30Z4kO7uPWsboteL6GoiXgl4R5o57q3b-78EhXkweeWzoRM06TGUbkUlVx_4xV2XuYUWJ1THXS9n-IF2QZ2vpnrpv50lG4ACcWxgZkOpRi-msuBQHGkvyrwVbU5t2YkGf6Y19X-R3Sgjtqn3Md4P93mC5G_1NX3YJqqnsdSZGa3ItxyuXyfKmhD3sHDqnLHV-_HREvj536GfHHuhwkQjOsw"}';
    ...
    async function loadKeypair() {
      keyPair = {};
      keyPair.publicKey = await importPublicKeyFromString(publicKeyJwkString);
      keyPair.privateKey = await importPrivateKeyFromString(privateKeyJwkString);
      console.log(keyPair);
    }
    ...
    function createAndSaveAKeyPair() {
      ...
      return window.crypto.subtle
        ...
        .then(async function (key) {
          keyPair = key;
          // const privateKeyJwk = await exportKeyToString(key.privateKey);
          // const publicKeyJwk = await exportKeyToString(key.publicKey);
    ...
    async function importPublicKeyFromString(jwkString) {
      ...
      const cryptoKey = await window.crypto.subtle.importKey(
        ...
        jwk, // the parsed JWK
        {
          ...
          hash: { name: "SHA-256" }, // hash used in your key
        },
    ...
    async function importPrivateKeyFromString(jwkString) {
      ...
      const cryptoKey = await window.crypto.subtle.importKey(
        ...
        jwk, // the parsed JWK
        {
          name: "RSA-OAEP", // algorithm id
          hash: { name: "SHA-256" }, // hash function
        },
        true, // whether the key is extractable (usually false for private keys)
        ["decrypt"] // key usage
      );
